...
CREATE TABLE IF NOT EXISTS `tb_book` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_book_tb_author_idx` (`id_author` ASC) VISIBLE,
  INDEX `fk_tb_book_category1_idx` (`id_category` ASC) VISIBLE,
  INDEX `fk_tb_book_tb_publisher1_idx` (`id_publisher` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `tb_loan` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_loan_tb_user1_idx` (`id_user` ASC) VISIBLE,
  INDEX `fk_tb_loan_return1_idx` (`id_return` ASC) VISIBLE,
  INDEX `fk_tb_loan_tb_book1_idx` (`id_book` ASC) VISIBLE,
